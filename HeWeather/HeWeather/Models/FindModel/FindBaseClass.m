...
#import "FindBaseClass.h"
#import "FindHeWeather6.h"


NSString *const kFindBaseClassHeWeather6 = @"HeWeather6";


@interface FindBaseClass ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation FindBaseClass
...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
    ...
    NSObject *receivedHeWeather6 = [dict objectForKey:kFindBaseClassHeWeather6];
    ...
    if ([receivedHeWeather6 isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedHeWeather6) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedHeWeather6 addObject:[FindHeWeather6 modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedHeWeather6 isKindOfClass:[NSDictionary class]]) {
       [parsedHeWeather6 addObject:[FindHeWeather6 modelObjectWithDictionary:(NSDictionary *)receivedHeWeather6]];
    }
...
- (NSDictionary *)dictionaryRepresentation {
    ...
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForHeWeather6] forKey:kFindBaseClassHeWeather6];
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    self.heWeather6 = [aDecoder decodeObjectForKey:kFindBaseClassHeWeather6];
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_heWeather6 forKey:kFindBaseClassHeWeather6];
}

- (id)copyWithZone:(NSZone *)zone {
    FindBaseClass *copy = [[FindBaseClass alloc] init];
