...
NSString *const kWeatherBaseClassHeWeather6 = @"HeWeather6";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
    ...
    NSObject *receivedHeWeather6 = [dict objectForKey:kWeatherBaseClassHeWeather6];
    ...
    if ([receivedHeWeather6 isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedHeWeather6) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedHeWeather6 addObject:[WeatherHeWeather6 modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedHeWeather6 isKindOfClass:[NSDictionary class]]) {
       [parsedHeWeather6 addObject:[WeatherHeWeather6 modelObjectWithDictionary:(NSDictionary *)receivedHeWeather6]];
    }
...
- (NSDictionary *)dictionaryRepresentation {
    ...
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForHeWeather6] forKey:kWeatherBaseClassHeWeather6];
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    self.heWeather6 = [aDecoder decodeObjectForKey:kWeatherBaseClassHeWeather6];
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_heWeather6 forKey:kWeatherBaseClassHeWeather6];
}
