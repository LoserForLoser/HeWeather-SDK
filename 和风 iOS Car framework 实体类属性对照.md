# 和风 iOS Car framework  请求URL对照表
URL类型 | URL代码 | 链接
--------- | ------------- | -----------
付费用户 | USER_TYPE_USER | https://api.heweather.com/s6/
普通用户 | USER_TYPE_FREE_USER | https://free-api.heweather.com/s6/
# 和风 iOS Car framework  实体类属性对照表
接口说明 | 接口代码（枚举） | 数据类
--------- | ------------- | -----------
